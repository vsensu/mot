...
//    glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
    ...
    shader.SetUniform("lightColor", 1.0f, 1.f, 1.f); // 或者使用着色器类设置
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.SetUniform("objectColor", 1.0f, 0.5f, 0.31f); // 或者使用着色器类设置
        ...
        // draw light
        shader.SetUniform("objectColor", 1.0f, 1.f, 1.f); // 或者使用着色器类设置
